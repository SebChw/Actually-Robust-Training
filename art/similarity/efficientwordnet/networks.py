...
#! Try to use their data generated by TF and then use my data withing tf.
#! Try to stay in TF make code good and then try to use Torch.
class BasicCNN(nn.Module):
    def __init__(self):
        super().__init__()

        self.network = nn.Sequential(
            nn.Conv1d(1, 32, kernel_size=160, stride=10),
            nn.ReLU(),
